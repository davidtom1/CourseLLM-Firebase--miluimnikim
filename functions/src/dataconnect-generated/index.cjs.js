...
const istEventsByUserAndCourseRef = (dcOrVars, vars) => {
...
exports.istEventsByUserAndCourseRef = istEventsByUserAndCourseRef;

exports.istEventsByUserAndCourse = function istEventsByUserAndCourse(dcOrVars, vars) {
  return executeQuery(istEventsByUserAndCourseRef(dcOrVars, vars));
};

const createIstEventRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'CreateIstEvent', inputVars);
}
createIstEventRef.operationName = 'CreateIstEvent';
exports.createIstEventRef = createIstEventRef;

exports.createIstEvent = function createIstEvent(dcOrVars, vars) {
